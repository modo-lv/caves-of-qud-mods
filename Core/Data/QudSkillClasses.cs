...
namespace ModoMods.Core.Data {
  ...
  public static class QudSkillClasses {
    ...
    public const String? Cleave = "Axe_Cleave";
    public const String? Dismember = "Axe_Dismember";
    public const String? Decapitate = "Axe_Decapitate";
    public const String? Berserk = "Axe_Berserk";
